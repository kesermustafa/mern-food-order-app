            ...
            <div className={' container mx-auto   w-full h-[600px] flex flex-col-reverse py-10 sm:p-0 sm:flex-row'}>
                ...
                <div className={"flex-1 sm:flex-8 flex flex-col   text-white justify-center "}>
                    ...
                    <div className={"flex flex-col gap-4 p-4 sm:p-0 sm:w-4/5"}>
                        <Title title={"We are KeserFood's"} desing={"text-5xl mb-8 text-amber-500"}/>
                        <p className={'font-exo text-gray-100 text-justify leading-relaxed '}>
                            At KeserFood's, we blend tradition and innovation to bring you a curated selection of
                            recipes, cooking tips, and food stories.
                            Our mission is to make great food accessible to everyone, whether you’re a beginner in the
                            kitchen or a seasoned chef.
                        ...
                        <Link href={"/about"} className={'flex mt-4 '}>
                            <button
                                className={'rounded-2xl bg-amber-400 px-6 py-2 cursor-pointer hover:bg-amber-500 transition-all'}>
                                Read More
                            </button>
                        </Link>
